...
namespace WebDriverBasics
{
    class YandexMainPage : BasePage
    {
        ...
        {
            //object letters = js.ExecuteScript($"var elements = document.querySelectorAll('{LetterCssSelector}'); return elements;");
            //return (letters as IReadOnlyCollection<IWebElement>).ToList();
